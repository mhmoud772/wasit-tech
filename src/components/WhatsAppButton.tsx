...
export default function WhatsAppButton() {
  return (
    <div className="fixed bottom-6 right-6 z-50 group">
      {/* Tooltip on Hover */}
      <div className="absolute bottom-full right-0 mb-3 hidden group-hover:block whitespace-nowrap bg-[var(--theme-bg-dark)] text-[var(--theme-text)] text-xs font-bold px-4 py-2 rounded-xl border border-wasit-teal/40 shadow-2xl animate-in fade-in duration-200">
        <span className="text-wasit-gold">واتساب وسيط-تك:</span> {COMPANY.phoneDisplay}
        <div className="absolute top-full right-5 border-4 border-transparent border-t-[var(--theme-bg-dark)]" />
      </div>
